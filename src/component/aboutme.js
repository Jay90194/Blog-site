...
export default function Aboutme() {
    ...
    <section className=" bg-transparent lg:h-129">
            ...
            <div className="mt-8 lg:mt-0 lg:w-1/2  lg:mx-20">
                    <div className="flex items-center lg:h-129 justify-center lg:justify-end">
                        <div className="max-w-lg">
                            <img className=" w-64 h-64 lg:h-129 lg:w-129 object-cover object-center rounded-full" src="https://images.unsplash.com/photo-1484627147104-f5197bcd6651?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80" alt=""/>
                        </div>
                    </div>
                </div>
                <div className="text-center py-16 lg:w-1/2">
                    <h2 className="text-black  font-sans text-6xl font-bold">Disha Agarwal</h2>
